...
java -cp TRMMailer.jar;mail-1.4.jar com.trm.mailer.TrmSendNotification smtp.ushrnd4.savvis.net PROD1.Relationship.Builder@Teradata.com "%%~ni%CURRTM%.txt" %USERMAIL% IC-PG-APAC-1CP@epsilon.com IC-PG-NA-1CP@epsilon.com IC-PG-EMEA-1CP@epsilon.com 25 4)