...
(	SELECT
	  CASE WHEN COALESCE(omee.Description,'') = '' THEN omee.Name ELSE omee.Description END (VARCHAR(1500))
	 ,omee.Display_Ord 
	...
	SELECT
	   direct.Description 
	      ...
	      ||CASE WHEN COALESCE(indirect.Description,'') = '' THEN indirect.Name ELSE indirect.Description END (VARCHAR(1500))
