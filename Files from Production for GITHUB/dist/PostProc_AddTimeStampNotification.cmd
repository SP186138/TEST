...
rem FileName: %jfile%
rem Posted Time Stamp:%CURRTM%
rem CommunicationId: %TRM_COM%
rem Submit USer: %TRM_USER%
rem Alternate email:PM230127@Teradata.com
rem Epsilon Recipients : IC-PG-APAC-1CP@epsilon.com IC-PG-NA-1CP@eps


 java -cp TrmSendNotif.jar com.trm.mailer.TrmSendNotification %Empty% PROD.Relationship.Builder@Teradata.com %jfile% %CURRTM% %TRM_COM% %TRM_USER% PM230127@Teradata.com IC-PG-APAC-1CP@epsilon.com IC-PG-NA-1CP@epsilon.com IC-PG-EMEA-1CP@epsilon.com
